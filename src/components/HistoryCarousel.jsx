...
const carouselItems = [
  ...
  },
  {
    date: "June 2023",
    description:
      "Our team got a lot bigger; We brought on a UI/UX designer, a blog writer, as well as nine interns. Our interns accomplished many things. We also had eight student leaders, volunteer members from highschool, to support outreach. Read our intern letters and blog posts on our old site blog.",
    image: june2023,
  },
  {
    date: "August 2023",
      ...
      <Carousel className="flex h-full w-full items-center justify-center">
        <CarouselContent>
          {carouselItems.map((item, index) => (
            <CarouselItem
              key={index}
              className="flex flex-col items-center space-y-4 pb-8 lg:pb-0 lg:flex-row lg:space-x-40"
            >
              <div className="flex flex-col items-center lg:w-1/2 lg:p-20">
                <div className="text-lg text-gray-600 font-bold text-center">
                  {item.date}
                </div>
                <div className="m-10 lg:my-0 flex items-center justify-center text-white font-bold lg:hidden">
                    <img
                      src={item.image}
                      alt="carousel image"
                ...
                <div className="text-lg text-gray-600 dark:text-gray-300 text-center lg:pr-8">
                  {item.description}
                </div>
              </div>
